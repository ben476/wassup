...
export default function Email({ email = {}, ...props }: { email?: EmailType, [key: string]: any }) {
    return <details className="group" open={email.open} {...props}>
        ...
        <div className='w-full px-6'>
            <iframe className={`w-full h-full text-gray-800 dark:text-gray-50 divide-y message-view-${email.id}`} srcDoc={email.bodyHTML} sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin" tabIndex={-1} />
